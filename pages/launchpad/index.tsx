...
export default function LaunchpadIndexPage() {
  ...
  return (
    <div className="flex flex-col justify-evenly items-start gap-3 px-4 w-full">
      <div className="flex flex-col justify-center items-center md:items-start gap-1 px-2 w-full">
        <span className="text-white text-[20px] md:text-[40px] ml-6 font-monumentExtended">Explore new collections coming to VEFI</span>
