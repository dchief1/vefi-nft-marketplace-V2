...
export default function index() {
  return (
    <div className='bg-[#01003E] w-full text-white py-4 md:py-8 lg:py-12'>
        <div 
            className="
            flex md:flex-row flex-col lg:flex-row justify-between
             lg:mx-12 
           ">
        ...
        {/* Firs Section */}
            <div className='px-8 md:px-8 '>
                ...
                '>
                 <Link href='/'><span> <FaDiscord /> </span></Link>
                 {/* <Link href='/'><h1 className='mr-12  hidden md:block'> Discord </h1></Link> */}
                 <Link href='/'><span> <FaYoutube /> </span></Link>
                </div>   
            </div> 
        {/* End of First Section */}

        {/* Second Section */}
            <div className="flex md:px-8  ml-8 flex-row  lg:flex-row">
        ...
        {/* End of Second Section */}
         ...
         {/* Last Section */}
         <div className='border-t border-white border-opacity-25 mt-8'>
              <p 
                className='
